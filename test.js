...
var rand = [],
    ...
    intrebare = [],
    raspuns_util = [],
    rand_base, verif_base, nr_base, nr_table_base, rasp_tau_tabel_base, rasp_tau_base, rasp_corect_tabel_base, rasp_corect_base, intrebare_tabel_base, intrebare_base;
...
window.onload = function () {
    ...
    rezultate_cont.style.width = 0.9 * 100 + 'vw';
    rezultate_cont.style.height = 0.9 * 100 + 'vh';
    ...
    rezultate_cont.style.border = 0.01 * 100 + 'vh solid black';
    ...
    verif_base.style.width = 0.05 * 0.9 * 100 + 'vw';
    verif_base.style.height = 0.0518 * 0.9 * 100 + 'vh';
    ...
    nr_base.style.width = 0.05 * 0.9 * 100 + 'vw';
    nr_base.style.height = 0.0518 * 0.9 * 100 + 'vh';
    ...
    intrebare_base.style.width = 0.4 * 0.9 * 100 + 'vw';
    intrebare_base.style.height = 0.0518 * 0.9 * 100 + 'vh';
    ...
    rasp_tau_base.style.width = 0.2 * 0.9 * 100 + 'vw';
    rasp_tau_base.style.height = 0.0518 * 0.9 * 100 + 'vh';
    ...
    rasp_corect_base.style.width = 0.2 * 0.9 * 100 + 'vw';
    rasp_corect_base.style.height = 0.0518 * 0.9 * 100 + 'vh';
    ...
    rasp_corect_base.style.marginLeft = 0.05 * 0.9 * 100 + 'vw';
    ...
    for (var i = 0; i <= 9; i++) {
        ...
        verif[i].style.width = 0.05 * 0.9 * 100 + 'vw';
        verif[i].style.height = 0.0718 * 0.9 * 100 + 'vh';
        ...
        nr[i].style.width = 0.05 * 0.9 * 100 + 'vw';
        nr[i].style.height = 0.0718 * 0.9 * 100 + 'vh';
        nr[i].className = 'n' + i;
        ...
        intrebare[i].style.width = 0.4 * 0.9 * 100 + 'vw';
        intrebare[i].style.height = 0.0718 * 0.9 * 100 + 'vh';
        ...
        rasp_tau[i].style.width = 0.2 * 0.9 * 100 + 'vw';
        rasp_tau[i].style.height = 0.0718 * 0.9 * 100 + 'vh';
        ...
        rasp_corect[i].style.width = 0.2 * 0.9 * 100 + 'vw';
        rasp_corect[i].style.height = 0.0718 * 0.9 * 100 + 'vh';
        rasp_corect[i].style.verticalAlign = "middle";
        rasp_corect[i].style.marginLeft = 0.05 * 0.9 * 100 + 'vw';
    ...
    for (var i = 0; i <= f.length - 1; i++) {
        f[i].style.width = 0.25 * 100 + 'vw';
        f[i].style.height = 0.08 * 100 + 'vh';
    }
    ...
    document.getElementById("test_alegere").style.width = 0.1 * 100 + 'vw';
    document.getElementById("test_alegere").style.height = 0.7 * 100 + 'vh';
    document.getElementById("test_alegere").style.marginLeft = 0.06 * 100 + 'vw';
    document.getElementById("test_cont").style.width = 0.7 * 100 + 'vw';
    document.getElementById("test_cont").style.height = 0.9 * 100 + 'vh';
    document.getElementById("test_cont").style.marginLeft = 0.06 * 100 + 'vw';

    document.getElementById('contmare').style.width = 0.7 * 100 + 'vw';
    document.getElementById('contmare').style.fontSize = 0.07 * 100 + 'vh';
    document.getElementById('contmare').style.marginTop = 0.1 * 100 + 'vh';
    document.getElementById("cont1").style.width = 0.7 * 100 + 'vw';
    document.getElementById("cont1").style.height = 0.5 * 100 + 'vh';
    document.getElementById("c0").style.marginTop = 0.03 * 100 + 'vh';
    document.getElementById("c0").style.width = 0.5 * 100 + 'vw';
    document.getElementById("c0").style.height = 0.09 * 100 + 'vh';

    document.getElementById("bara").style.marginTop = 0.015 * 100 + 'vh';
    document.getElementById("cont2").style.marginTop = 0.04 * 100 + 'vh';
    document.getElementById("cont3").style.marginTop = 0.03 * 100 + 'vh';
    document.getElementById("c1").style.left = 0.05 * 100 + 'vw';
    document.getElementById("c2").style.right = 0.05 * 100 + 'vw';
    document.getElementById("c3").style.left = 0.05 * 100 + 'vw';
    document.getElementById("c4").style.right = 0.05 * 100 + 'vw';
    document.getElementById("cont2").style.height = 0.1 * 100 + 'vh';
    document.getElementById("cont3").style.height = 0.1 * 100 + 'vh';
    document.getElementById("STARTBUTTON").style.width = 0.15 * 100 + 'vw';
    document.getElementById("STARTBUTTON").style.height = 0.075 * 100 + 'vh';
    document.getElementById("STARTBUTTON").style.lineHeight = 0.075 * 100 + 'vh';
    document.getElementById("STARTBUTTON").style.marginTop = 0.0 * 100 + 'vh';
    document.getElementById("filmrolls").style.marginTop = 0.63 * 100 + 'vh';
    document.getElementById("filmrolls").style.height = 0.25 * 100 + 'vh';
    document.getElementById("filmrolls").style.width = 0.6 * 100 + 'vw';
    document.getElementById("filmrolls").style.marginLeft = 0.085 * 100 + 'vw';

    document.getElementById('puncte').style.width = 0.7 * 0.3 * 100 + 'vw';
    document.getElementById('intrebare').style.width = 0.7 * 0.3 * 100 + 'vw';
    document.getElementById('viteza').style.width = 0.7 * 0.3 * 100 + 'vw';
    document.getElementById('puncte').style.marginLeft = 0.7 * 0.03 * 100 + 'vw';
    document.getElementById('intrebare').style.marginLeft = 0.7 * 0.03 * 100 + 'vw';
    document.getElementById('viteza').style.marginLeft = 0.7 * 0.03 * 100 + 'vw'
    document.getElementById('puncte').style.height = 0.1 * 100 + 'vh';
    document.getElementById('intrebare').style.height = 0.1 * 100 + 'vh';
    document.getElementById('viteza').style.height = 0.1 * 100 + 'vh';
    ...
    for (var i = 0; i <= alegere_elem.length - 1; i++) {
        alegere_elem[i].style.width = 0.075 * 100 + 'vw';
        alegere_elem[i].style.height = 0.075 * 100 + 'vw';
        alegere_elem[i].style.marginLeft = 0.0125 * 100 + 'vw';
        alegere_elem[i].style.marginTop = 0.006 * 100 + 'vw';
    }

    var text_cont = document.getElementsByClassName("text_cont");
    for (var i = 0; i <= text_cont.length - 1; i++) {
        text_cont[i].style.width = 0.16 * 100 + 'vw';
        text_cont[i].style.height = 0.075 * 100 + 'vw'
        text_cont[i].style.marginLeft = -0.25 * 100 + 'vw';
        text_cont[i].style.lineHeight = 0.075 * 100 + 'vw';
    }
    ...
    function wait() {
        if (ok == 0) {
            ...
            setTimeout(function () {
                ...
                document.getElementById("c4").style.background = "radial-gradient(ellipse at center, rgba(0,0,0,0) 0%,rgba(0,0,0,1) 100%)";
            }, 3500);
